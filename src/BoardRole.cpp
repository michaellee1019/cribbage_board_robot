...
std::map<uint32_t, BoardRoleConfig> boardRoleConfig = {
    {2934574912, {BoardRole::Player_Red, 2934574912, "RED", 1, 0xFF0000}},
    {860931256, {BoardRole::Player_Blue, 860931256, "BLUE", 2, 0x0000FF}},
    {2934574676, {BoardRole::Player_Green, 2934574676, "GREN", 3, 0x00FF00}},
    {2934416992, {BoardRole::Player_White, 2934416992, "WHIT", 4, 0xFFFFFF}},
    {2934577084, {BoardRole::Leader, 2934577084, "LEADER", 0, 0x000000}},
    {0, {BoardRole::Unknown, 0, "UNKNOWN", -1, 0x000000}},
};
